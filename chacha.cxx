...
void ChaChaTLS_Policy::CipherSetKey(const NameValuePairs &params, const byte *key, size_t length)
{
    ...
    get(m_state[XVSA_KEY+0])(m_state[XVSA_KEY+1])(m_state[XVSA_KEY+2])(m_state[XVSA_KEY+3])
        (m_state[XVSA_KEY+4])(m_state[XVSA_KEY+5])(m_state[XVSA_KEY+6])(m_state[XVSA_KEY+7]);
}
...
void ChaChaTLS_Policy::CipherResynchronize(byte *keystreamBuffer, const byte *IV, size_t length)
{
    ...
    std::memcpy(m_state+4, m_state+XVSA_KEY, 8*sizeof(word32));
